"""
Practice Tracks, a Python ReaScript (Reaper 5.1)
...
Typical Usage:
    1. In Reaper, slice an audio track into contiguous media items representing
       ...
       See http://wiki.cockos.com/wiki/index.php/Tempo_mapping_with_SWS for
       details.
...
from PTKmodules.PTKclasses import run

        
RPR_Undo_BeginBlock()
run()
RPR_Undo_EndBlock("Script execution", -1)
